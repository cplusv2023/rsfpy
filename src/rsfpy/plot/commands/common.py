...
_MODE_PARAMETERS = {
    "grey": (
        ...
        ("string", "barlabelfat/barlabelweight=normal", "color-bar label font weight."),
        ("float", "barlabelsz/barlabelsize=12.", "color-bar label font size."),
        ("string", "formatbar/barformat=", "color-bar tick format."),
        ("float", "nticbar/ntickbar=5", "maximum color-bar tick count."),
    ...
    "graph": (
        ...
        ("float", "markersize/markersz/symbolsize/symbolsz=", "marker size."),
        ("bool", "stem=n", "draw a stem plot instead of connected traces."),
        ("bool", "legend=n", "draw a trace legend."),
        ("string", "legends=", "trace legend labels separated by commas, spaces, or semicolons."),
        ("string", "wherelegend=best", "Matplotlib legend location."),
        ("bool", "legendbox=n", "draw a legend frame."),
        ("float", "legendsize= legendncol=1 legendalpha=.8", "legend text size, columns, and frame opacity."),
        ("string", "legendfat/legendweight=", "legend font weight."),
